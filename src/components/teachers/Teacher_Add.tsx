...
import { create_teacher } from "../../Services/Allservice";
import { useNavigate } from "react-router-dom";
const AddTeacher = () => {
const navigate = useNavigate()
  const createTeacher = async (e: any) => {
    e.preventDefault();
    ...
    try {
      ...
      const response = await create_teacher(data);
      ...
      console.error("error in create teacher", err);
    }
  };
  return (
